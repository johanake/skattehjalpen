...
export const ReceiptUpload: React.FC<ReceiptUploadProps> = ({ declarationId, onUploadSuccess }) => {
  ...
  return (
    <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
      <h3 className="text-lg font-semibold mb-4 text-white">Ladda upp kvitto</h3>
      ...
      <form onSubmit={handleFileUpload} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">Belopp (kr)</label>
            <input
              type="number"
              step="0.01"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">Datum</label>
            <input
              type="date"
              value={formData.date}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-200 mb-1">Beskrivning</label>
          <textarea
        ...
        {error && (
          <div className="p-3 bg-red-900 border border-red-400 text-red-200 rounded">
            {error}
          </div>
        )}
      </form>
