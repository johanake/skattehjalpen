...
export const ReceiptUpload: React.FC<ReceiptUploadProps> = ({ declarationId, onUploadSuccess }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
      <h3 className="text-lg font-semibold mb-4 text-gray-800">Ladda upp kvitto</h3>
      ...
      <form onSubmit={handleFileUpload} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full p-2 border border-gray-300 rounded bg-white text-gray-800 focus:ring-2 focus:ring-green-600"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-1">Belopp (kr)</label>
            <input
              type="number"
              step="0.01"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1">Beskrivning</label>
          <textarea
